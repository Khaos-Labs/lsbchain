...
import (
	...
	"github.com/Khaos-Labs/lsbchain/crypto/hd"
	ethermint "github.com/Khaos-Labs/lsbchain/types"
	evmtypes "github.com/Khaos-Labs/lsbchain/x/evm/types"
)
...
Note, strict routability for addresses is turned off in the config file.`,
		...
		Example: "lsbchain testnet --v 4 --keyring-backend test --output-dir ./output --starting-ip-address 192.168.10.2",
	...
	cmd.Flags().String(flagNodeDaemonHome, "lsbchaind", "Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "lsbchaincli", "Home directory of the node's cli configuration")
	...
	cmd.Flags().String(server.FlagMinGasPrices, fmt.Sprintf("0.000006%s", ethermint.AttoPhoton), "Minimum gas prices to accept for transactions; All fees in a tx must meet this minimum (e.g. 0.01lsb,0.001lsb)")
...
func InitTestnet(
	...
	if chainID == "" {
		chainID = fmt.Sprintf("lsbchain-%d", tmrand.Int63n(9999999999999)+1)
	}
