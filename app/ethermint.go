...
import (
	...
	ethermintcodec "github.com/Khaos-Labs/lsbchain/codec"
...
const appName = "Lsbchain"

var (
	// DefaultCLIHome sets the default home directories for the application CLI
	DefaultCLIHome = os.ExpandEnv("$HOME/.lsbchaincli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.lsbchaind")
