...
import (
	...
	"github.com/Khaos-Labs/lsbchain/app/ante"
	"github.com/Khaos-Labs/lsbchain/types"
...
func (suite *AnteTestSuite) TestEthInvalidSig() {
	...
	ctx := suite.ctx.WithChainID("lsbchain-4")
...
func (suite *AnteTestSuite) TestEthInvalidMempoolFees() {
	...
	suite.ctx = suite.app.BaseApp.NewContext(true, abci.Header{Height: 1, ChainID: "lsbchain-3", Time: time.Now().UTC()})
