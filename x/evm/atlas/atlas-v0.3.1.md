...
See the Lsbchain [JSON-RPC docs](https://docs.lsbchain.zone/basics/json_rpc.html) for reference.

## Documentation and Specification

* Lsbchain documentation: [https://docs.lsbchain.zone](https://docs.lsbchain.zone)
