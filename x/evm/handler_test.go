...
import (
	...
	"github.com/Khaos-Labs/lsbchain/app"
	"github.com/Khaos-Labs/lsbchain/crypto/ethsecp256k1"
	ethermint "github.com/Khaos-Labs/lsbchain/types"
	"github.com/Khaos-Labs/lsbchain/x/evm"
	"github.com/Khaos-Labs/lsbchain/x/evm/keeper"
	"github.com/Khaos-Labs/lsbchain/x/evm/types"
...
func (suite *EvmTestSuite) SetupTest() {
	...
	suite.ctx = suite.app.BaseApp.NewContext(checkTx, abci.Header{Height: 1, ChainID: "lsbchain-3", Time: time.Now().UTC()})
